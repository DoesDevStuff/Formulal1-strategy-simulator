...
public class Constants {
  ...
  public static int RACE_LENGTH = 12000;
  public static int DISPLAY_THRESHOLD_LENGTH = 100;
  public static int DISPLAY_THRESHOLD_TIME = 100;

  //SPEED STATS
  public static int BASE_SPEED = 150; //km/hr
  public static int BASE_ACCELERATION = 20; // in m/s^2
  public static int THRESHOLD_SPEED = 10; //difference of speed between each car
  ...
  public static double STARTING_DISTANCE = 100; //every car is at x distance, from each other in a line
